    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_street_address_1', models.CharField(blank=True, max_length=90, null=True)),
                ('default_street_address_2', models.CharField(blank=True, max_length=90, null=True)),
                ('default_town_or_city', models.CharField(blank=True, max_length=90, null=True)),
